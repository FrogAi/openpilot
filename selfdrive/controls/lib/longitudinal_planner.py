...
class LongitudinalPlanner:
  ...
  def update(self, classic_model, radarless_model, sm, frogpilot_toggles):
    ...
    if classic_model:
      self.output_a_target, self.output_should_stop = get_accel_from_plan_classic(self.CP, self.v_desired_trajectory, self.a_desired_trajectory, vEgoStopping=frogpilot_toggles.vEgoStopping)
    else:
